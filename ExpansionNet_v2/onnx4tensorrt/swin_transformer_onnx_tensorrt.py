...
class WindowAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask: torch.Tensor, mask_is_none: bool):
        """
        Args:
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        if self.shift_size > 0:
            ...
            self.attn_mask_is_none = False
        else:
            self.attn_mask_is_none = True
            attn_mask = torch.ones((1, 1))   # just a dummy value for torch.jit.script
